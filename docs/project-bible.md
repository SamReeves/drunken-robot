...
* **Additive Ensemble:**
* *Accordion:* Lead melody & bellows swells (unlocked by default).
* *Upright Bass:* Grounding rhythmic pulse (unlocked via tips/momentum).
* *Castanets/Percussion:* Polyrhythms for passing hazards.
* *Flamenco Guitar:* Syncopated comping for crowded zones.
* *Violin:* Melodic ornamentation for high-multiplier combos.
